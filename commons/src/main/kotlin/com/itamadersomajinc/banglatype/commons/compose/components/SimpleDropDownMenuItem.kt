package com.itamadersomajinc.banglatype.commons.compose.components
...
private fun SimpleDropDownMenuItemPreview() {
    AppThemeSurface {
        SimpleDropDownMenuItem(text = com.itamadersomajinc.banglatype.commons.R.string.copy, onClick = {})
    }
}
