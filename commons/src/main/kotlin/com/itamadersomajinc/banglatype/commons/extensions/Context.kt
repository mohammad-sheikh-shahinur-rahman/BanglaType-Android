...
import com.itamadersomajinc.banglatype.commons.helpers.AppLockManager
import com.itamadersomajinc.banglatype.commons.helpers.BaseConfig
import com.itamadersomajinc.banglatype.commons.helpers.ContactsHelper
import com.itamadersomajinc.banglatype.commons.helpers.DAY_SECONDS
import com.itamadersomajinc.banglatype.commons.helpers.FONT_SIZE_LARGE
import com.itamadersomajinc.banglatype.commons.helpers.FONT_SIZE_MEDIUM
import com.itamadersomajinc.banglatype.commons.helpers.FONT_SIZE_SMALL
import com.itamadersomajinc.banglatype.commons.helpers.FRIDAY_BIT
import com.itamadersomajinc.banglatype.commons.helpers.HOUR_SECONDS
import com.itamadersomajinc.banglatype.commons.helpers.KEY_MAILTO
import com.itamadersomajinc.banglatype.commons.helpers.MINUTE_SECONDS
import com.itamadersomajinc.banglatype.commons.helpers.MONDAY_BIT
import com.itamadersomajinc.banglatype.commons.helpers.MONTH_SECONDS
import com.itamadersomajinc.banglatype.commons.helpers.MyContactsContentProvider
import com.itamadersomajinc.banglatype.commons.helpers.MyContentProvider
import com.itamadersomajinc.banglatype.commons.helpers.MyContentProvider.PERMISSION_WRITE_GLOBAL_SETTINGS
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_ACCESS_COARSE_LOCATION
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_ACCESS_FINE_LOCATION
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_CALL_PHONE
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_CAMERA
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_GET_ACCOUNTS
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_MEDIA_LOCATION
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_POST_NOTIFICATIONS
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_READ_CALENDAR
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_READ_CALL_LOG
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_READ_CONTACTS
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_READ_MEDIA_AUDIO
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_READ_MEDIA_IMAGES
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_READ_MEDIA_VIDEO
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_READ_MEDIA_VISUAL_USER_SELECTED
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_READ_PHONE_STATE
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_READ_SMS
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_READ_STORAGE
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_READ_SYNC_SETTINGS
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_RECORD_AUDIO
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_SEND_SMS
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_WRITE_CALENDAR
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_WRITE_CALL_LOG
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_WRITE_CONTACTS
import com.itamadersomajinc.banglatype.commons.helpers.PERMISSION_WRITE_STORAGE
import com.itamadersomajinc.banglatype.commons.helpers.PREFS_KEY
import com.itamadersomajinc.banglatype.commons.helpers.SATURDAY_BIT
import com.itamadersomajinc.banglatype.commons.helpers.SUNDAY_BIT
import com.itamadersomajinc.banglatype.commons.helpers.THURSDAY_BIT
import com.itamadersomajinc.banglatype.commons.helpers.TIME_FORMAT_12
import com.itamadersomajinc.banglatype.commons.helpers.TIME_FORMAT_12_WITH_SECS
import com.itamadersomajinc.banglatype.commons.helpers.TIME_FORMAT_24
import com.itamadersomajinc.banglatype.commons.helpers.TIME_FORMAT_24_WITH_SECS
import com.itamadersomajinc.banglatype.commons.helpers.TUESDAY_BIT
import com.itamadersomajinc.banglatype.commons.helpers.WEDNESDAY_BIT
import com.itamadersomajinc.banglatype.commons.helpers.WEEK_SECONDS
import com.itamadersomajinc.banglatype.commons.helpers.YEAR_SECONDS
import com.itamadersomajinc.banglatype.commons.helpers.YOUR_ALARM_SOUNDS_MIN_ID
...
import com.itamadersomajinc.banglatype.commons.helpers.isOnMainThread
...
import com.itamadersomajinc.banglatype.commons.helpers.proPackages
import com.itamadersomajinc.banglatype.commons.models.AlarmSound
import com.itamadersomajinc.banglatype.commons.models.BlockedNumber
...
import com.itamadersomajinc.banglatype.commons.helpers.FossifyThankYou
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.itamadersomajinc.banglatype.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isAProApp() = packageName.startsWith("com.itamadersomajinc.banglatype.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.itamadersomajinc.banglatype."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.itamadersomajinc.banglatype.contacts") && !packageName.startsWith("com.itamadersomajinc.banglatype.phone")) {
        true
    } else if ((packageName.startsWith("com.itamadersomajinc.banglatype.contacts") || packageName.startsWith("com.itamadersomajinc.banglatype.phone")) && isQPlus()) {
