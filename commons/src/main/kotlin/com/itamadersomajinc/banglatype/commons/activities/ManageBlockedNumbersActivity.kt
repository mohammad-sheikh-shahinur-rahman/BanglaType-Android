...
import com.itamadersomajinc.banglatype.commons.compose.extensions.onEventValue
import com.itamadersomajinc.banglatype.commons.compose.screens.ManageBlockedNumbersScreen
import com.itamadersomajinc.banglatype.commons.compose.theme.AppThemeSurface
import com.itamadersomajinc.banglatype.commons.dialogs.AddOrEditBlockedNumberAlertDialog
import com.itamadersomajinc.banglatype.commons.dialogs.ExportBlockedNumbersDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("com.itamadersomajinc.banglatype.phone")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.itamadersomajinc.banglatype.phone")) {
