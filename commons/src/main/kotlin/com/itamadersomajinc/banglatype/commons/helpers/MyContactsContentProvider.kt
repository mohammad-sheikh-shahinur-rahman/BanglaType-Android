...
import com.itamadersomajinc.banglatype.commons.extensions.getIntValue
import com.itamadersomajinc.banglatype.commons.extensions.getStringValue
import com.itamadersomajinc.banglatype.commons.models.PhoneNumber
import com.itamadersomajinc.banglatype.commons.models.SimpleContact
import com.itamadersomajinc.banglatype.commons.models.contacts.Contact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.itamadersomajinc.banglatype.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.itamadersomajinc.banglatype.phone" && packageName != "com.itamadersomajinc.banglatype.messages" && packageName != "com.itamadersomajinc.banglatype.calendar") {
                return contacts
            }
